...
var randomBytes: string | any[] | Buffer;
...
var randomNumber = function(max: number) {
...
var generate = function(options: { [x: string]: string; length?: any; }, pool: string | any[]) {
	var password = '',
...
self.generate = function(options: { length?: any; numbers?: any; symbols?: any; exclude?: any; uppercase?: any; lowercase?: any; excludeSimilarCharacters?: any; strict?: any; }) {
	// Set defaults.
	options = options;
...
self.generateMultiple = function(amount: number, options: any) {
	var passwords = [];

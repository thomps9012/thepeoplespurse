...
var MongoDbProvider = /** @class */ (function () {
    ...
    Object.defineProperty(MongoDbProvider.prototype, "votesCollection", {
        get: function () {
            var votesCollection = this.getCollection('votes');
            if (!votesCollection) {
    ...
    Object.defineProperty(MongoDbProvider.prototype, "classesCollection", {
        get: function () {
            var classesCollection = this.getCollection('classes');
    ...
    Object.defineProperty(MongoDbProvider.prototype, "teachersCollection", {
        get: function () {
            var teachersCollection = this.getCollection('teachers');
    ...
    MongoDbProvider.prototype.closeAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.mongoClient.close()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }

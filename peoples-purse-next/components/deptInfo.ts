...
export const DeptInfo = [
  ...
  // dept of homeland security
  {
    ...
    abbr: 'DOHS',
    icon: DOHS,
    mission: 'To secure the nation from the many threats we face. This requires the dedication of more than 240,000 employees in jobs that range from aviation and border security to emergency response, from cybersecurity analyst to chemical facility inspector.',
  ...
  // dept of education
  {
    ...
    abbr: 'DOED',
    icon: DOED,
    mission: "To promote student achievement and prepation for global competitiveness by fostering educational excellence and ensuring equal access.",
  ...
  // dept of health and human services
  {
    ...
    abbr: 'HHS',
    icon: DOHHS,
    mission: 'To enhance the health and well-being of all Americans, by proviging for effective health and human services and by fostering sound, sustained advances in the sciences underlying medicine, public health, and social services.',
  ...
  // federal election comission
  {
    ...
    abbr: 'FEC',
    icon: FEC,
    mission: 'To protect the integrity of the campaign finance process by providing transparency and fairly enforcing and administering federal campaign finance laws.',
  ...
  // equal employment opportunity comission
  {
    ...
    abbr: 'EEOC',
    icon: EEOC,
    mission: 'To prevent and remedy unlawful employment discrimination and to advance equal opportunity for all in the workplace. I call upon everyong to work to ensure that the EEOC sets the best example of equity, diversity, and inclusivenss for all workplaces.',
  ...
  // social security
  {
    ...
    abbr: 'SSA',
    icon: SSA,
    mission: 'Committed to helping maintain the basic well-being and protection of the people we serve through promoting economic secuirty via compassionate and vigilant leadership.',
